              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="item">
                    ...
                    <div className="exp">
                      <h2 className="nmb-font"><span className="color-font">{AboutUs3date.exp.name1}</span></h2>
                      <h5>{AboutUs3date.exp.name}</h5>
                    </div>
                  </div>
                </div>
                <div className="col-md-6">
            ...
            <div className="content">
              <Split>
                <h4 className="wow words chars splitting" data-splitting>
                  {AboutUs3date.title.first} <br /> {AboutUs3date.title.second} <br /> {AboutUs3date.title.third}
                </h4>
              </Split>
              <Split>
