          ...
          <div className='col-lg-5 valign'>
            <div className='content wow fadeInUp md-mb30' data-wow-delay='.5s'>
              ...
              <h3 className='co-tit mb-15'>
                We are Lunatics who pray for the endless development of Terra.
              </h3>
              <p>
                We aim for the developmental direction of LunaDAO. We are also
                Lunatics who support the expansion of the Terra ecosystem.
              </p>
